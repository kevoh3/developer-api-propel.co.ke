...
//        return $this->hasOne(DeveloperApiCredential::class,"user_id")->where("mode", payment_gateway_const()::ENV_SANDBOX);
//    }
//    public function productionApis() {
//        return $this->hasMany(DeveloperApiCredential::class, "user_id")->where("mode", payment_gateway_const()::ENV_PRODUCTION);
//    }
//productionApis
